<?php
    ...
    $query = query("SELECT * FROM buku ORDER BY tanggal_input DESC");
    $buku = $query;

    if(isset($_GET['keyword'])){
    $keyword = $_GET['keyword'];
    $buku = query("SELECT * FROM buku WHERE nama LIKE '%$keyword%'");
    }

    if(isset($_POST['tombol_search'])){
       
        $produk = search_data($_POST['keyword']);
    }
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  ...
                  alt="User Image"
                />
                <span class="d-none d-md-inline">Amanda Rahmawati Hidayat</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                <!--begin::User Image-->
                <li class="user-header text-bg-primary">
                  <img
                    src="dist/assets/img/pp1.jpg"
                    class="rounded-circle shadow"
                    alt="User Image"
                  />
                  <p>
                    Amanda Rahmawati Hidayat - Web Developer
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="index.php" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">UJIKOM PROMNET</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
              ...
              <!-- =============== ISI TABEL ADA DI SINI =============== -->
                <table class="table table-striped table-hover">
                  ...
                  <tr>
                    ...
                    <td>
                        <img src="img/<?= $data['gambar_cover'] ?>" height="70" width="70" alt="">
                    </td>
                    <td><?= $data['kategori'] ?></td>

                    <td>
                      <a href="ubah_buku.php?id_buku=<?= $data['id_buku'] ?>" class="btn-sm btn-success btn">Edit</a>
      ...
      <footer class="app-footer">
        <!--begin::To the end-->
        <div class="float-end d-none d-sm-inline">UJIKOM PROMNET</div>
        <!--end::To the end-->
        <!--begin::Copyright-->
        <strong>
          Copyright &copy; 2025&nbsp;
